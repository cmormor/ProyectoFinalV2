...
export const FormularioNomina = ({ nomina, plantilla, plantillaEmisores, onGuardar, onCrear, onBuscarEmpleado, onBuscarEmisor }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="container mt-4 w-75 shadow-lg p-4 rounded">
            <h2 className="mb-4 text-center text-primary">{nomina ? 'Editar Nómina' : 'Crear Nómina'}</h2>
            <hr />
            <div className="form-group mb-4">
                <h3 className="text-primary">Datos del Emisor (no editables)</h3>
                {plantillaEmisores && (
                    <select
                        name="emisorCIF"
                        value={emisor.CIF}
            ...
            <div className="form-group mb-4">
                <h3 className="text-primary">Datos del Receptor (no editables)</h3>
                {plantilla && (
                    <select
                        name="receptorId"
            ...
            <div className="d-flex flex-column mb-4 gap-4">
                <h3 className="text-primary">Datos Generales de la Nómina</h3>
